...
def main() -> None:
    ...
    parser.add_argument("--file-name", default= "all", help="Which redirect file to convert, defaults to all redirect files in the scraped-redirects/sorted dir", type=str)
